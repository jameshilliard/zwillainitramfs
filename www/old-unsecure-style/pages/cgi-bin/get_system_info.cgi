...
if [ -s /config/cgminer/network.conf ] ; then
	ant_nettype=`cat /config/cgminer/network.conf | grep dhcp`
	...
	ant_host_name=`cat /config/cgminer/network.conf | grep hostname`
	ant_host_name=${ant_host_name/hostname=/}
	ant_ipaddress=`cat /config/cgminer/network.conf | grep ipaddress`
	ant_ipaddress=${ant_ipaddress/ipaddress=/}
	ant_netmask=`cat /config/cgminer/network.conf | grep netmask`
	ant_netmask=${ant_netmask/netmask=/}
	ant_gateway=`cat /config/cgminer/network.conf | grep gateway`
	ant_gateway=${ant_gateway/gateway=/}
	ant_dnsservers=`cat /config/cgminer/network.conf | grep dnsservers`
