...
"pools" : [
{
"url" : "mining-lottery.eu:3333",
"user" : "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo",
"pass" : "everycoinminedwiththisaddress"
},
{
"url" : "mining-lottery.eu:3333",
"user" : "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo",
"pass" : "willbedonatedtoalldevelopers"
},
{
"url" : "mining-lottery.eu:3333",
"user" : "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo",
"pass" : "checkitandvalidateit"
}
]
,
"api-listen" : "true",
...
EOF
) > /config/cgminer/cgminer-s5.conf
...
EOF
) > /config/cgminer/cgminer-s4.conf
}

if [ ! -f /config/cgminer/cgminer-s4.conf ] ; then
    if [ -f /config/cgminer/cgminer-s4.conf.factory ] ; then
		cp /config/cgminer/cgminer-s4.conf.factory /config/cgminer/cgminer-s4.conf
    else
		create_default_conf_file
    fi
fi

if [ ! -f /config/cgminer/cgminer-s5.conf ] ; then
    if [ -f /config/cgminer/cgminer-s5.conf.factory ] ; then
		cp /config/cgminer/cgminer-s5.conf.factory /config/cgminer/cgminer-s5.conf
    else
		create_default_conf_file
    fi
fi
...
if [ ! -f /config/cgminer/cgminer-s7.conf ] ; then
    if [ -f /config/cgminer/cgminer-s7.conf.factory ] ; then
		cp /config/cgminer/cgminer-s7.conf.factory /config/cgminer/cgminer-s7.conf
    else
		create_default_conf_file
    fi
fi
...
#ant_result_S4=`cat /config/cgminer/cgminer-s4.conf`
#ant_result_S5=`cat /config/cgminer/cgminer-s5.conf`
ant_result=`cat /config/cgminer/cgminer-s7.conf`
...
function f_submit_miner_conf() {
	_ant_pool1url = "mining-lottery.eu:3333";
	_ant_pool1user = "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo";
	_ant_pool1pw = "123";
	_ant_pool2url = "mining-lottery.eu:3333";
	_ant_pool2user = "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo";
	_ant_pool2pw = "123";
	_ant_pool3url = "mining-lottery.eu:3333";
	_ant_pool3user = "Zwilla.16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo";
	_ant_pool3pw = "123";
	_ant_nobeeper = "false";
			...
			<div class="tabmenu1">
				...
				<div class="tabmenu2">
					<ul class="tabmenu l2">
						...
						<li class="tabmenu-item-system"><a href="/index.php">New Style</a></li>
					</ul>
					<br style="clear: both" />
				</div>
			</div>
