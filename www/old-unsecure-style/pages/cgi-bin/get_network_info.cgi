...
if [ -s /config/cgminer/network.conf ] ; then	
	ant_conf_hostname=`cat /config/cgminer/network.conf | grep hostname`
	ant_conf_hostname=${ant_conf_hostname/hostname=/}
	ant_conf_ipaddress=`cat /config/cgminer/network.conf | grep ipaddress`
	ant_conf_ipaddress=${ant_conf_ipaddress/ipaddress=/}
	ant_conf_netmask=`cat /config/cgminer/network.conf | grep netmask`
	ant_conf_netmask=${ant_conf_netmask/netmask=/}
	ant_conf_gateway=`cat /config/cgminer/network.conf | grep gateway`
	ant_conf_gateway=${ant_conf_gateway/gateway=/}
	ant_conf_dnsservers=`cat /config/cgminer/network.conf | grep dnsservers`
