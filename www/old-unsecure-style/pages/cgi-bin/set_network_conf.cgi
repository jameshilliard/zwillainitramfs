...
if [ "${ant_conf_nettype}" == "DHCP" ]; then
	echo "dhcp=true"								>  /config/cgminer/network.conf
	echo "hostname=${ant_conf_hostname}"			>> /config/cgminer/network.conf
else
	echo "hostname=${ant_conf_hostname}"			>  /config/cgminer/network.conf
	echo "ipaddress=${ant_conf_ipaddress}"			>> /config/cgminer/network.conf
	echo "netmask=${ant_conf_netmask}"				>> /config/cgminer/network.conf
	echo "gateway=${ant_conf_gateway}"				>> /config/cgminer/network.conf
	echo "dnsservers=\"${ant_conf_dnsservers}"\"	>> /config/cgminer/network.conf
fi
sync &
