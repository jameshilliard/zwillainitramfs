                            ...
                            <form class="form-horizontal" role="form">
                                <fieldset class="floated">
                                    ...
                                    <div class="form-group checkbox">
                                        <input id="threshold-temps" class="enabler" type="checkbox" name="thresholds[temps][enabled]" <?php echo ($rigSettings['settings']['temps']['enabled']) ? 'checked' : '' ?> value="1" /> 
                                        <label for="threshold-temps">Enable Temperature Warnings</label>
                                    </div>
