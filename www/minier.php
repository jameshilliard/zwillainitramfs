...
$rigs = array('192.168.178.41:4028');
#
...
#
$tablebegin = '<tr><td><table class "panel-heading">';
...
if (file_exists('/config/myminer.php'))
 include_once('/config/myminer.php');
#
