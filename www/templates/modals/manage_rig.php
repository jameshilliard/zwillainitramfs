<div class="modal fade" id="manageRig" tabindex="-1" role="dialog" aria-labelledby="manageRigLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h2 class="modal-title"><i class="icon icon-pixelpickaxe"></i> Manage <span class="rig-name"></span></h2>
      </div>
      <div class="modal-body">
         <div class="new-panel-choices">
            ...
            <a class="new-panel-btn btn-cpu-processor" action="./my_local_miner.php" href="./my_local_miner.php" ><i class="icon icon-cpu-processor"></i>Setup Miner</a>       
         </div>
      </div>
