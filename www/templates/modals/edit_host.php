<!-- Modal -->
<div class="modal fade" id="editRig" tabindex="-1" role="dialog" aria-labelledby="editRigLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <form class="form-horizontal" role="form">
         ...
         <div class="modal-footer">
           ...
           <button type="button" class="btn btn-lg btn-success" id="btnSaveHost"><i class="icon icon-save-floppy"></i> Save</button>
         </div>
      </form>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
