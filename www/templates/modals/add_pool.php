    ...
    <div class="modal-content">
      <form class="form-horizontal" role="form">
         <div class="modal-header">
           ...
           <h2 class="modal-title title-add" ><i class="icon icon-circleadd"></i> Add a Mining Pool</h2>
           <h2 class="modal-title title-edit" ><i class="icon icon-circleadd"></i> Edit <span class="pool-name"></span></h2>
         </div>
         <div class="modal-body">
          ...
          <div class="form-group all">
           ...
           <div class="form-group mpos simplecoin nomp ckpool p2pool" >
           ...
           <div class="form-group mpos bitcoinaffiliatenetwork btcguild simplecoin eclipse trademybit multipoolus ckpool slush antpool bitminter ghash" >
           ...
           <div class="form-group antpool ghash" >
           ...
           <div class="form-group mpos bitcoinaffiliatenetwork ckpool antpool bitminter burstninja ghash" >
           ...
           <div class="form-group wafflepool eligius magicpool nomp p2pool nicehash westhash ckpoolsolo" >
             <label for="inputAddress" class="col-sm-3 control-label">Mining Address</label>
             <div class="col-sm-7">
               <input type="text" class="form-control" id="inputAddress" name="address" placeholder="16L45ub3SpHZ6dYbqseip7Fv4BEJSj9xEo" />
             </div>
           </div>
