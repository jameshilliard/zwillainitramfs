...
<div id="maincontainer">
	...
	<ul class="tabmenu l1">
		...
		<li class="tabmenu-item-system"><a href="minerConfiguration.cgi">Miner Configuration</a></li>
		<li class="tabmenu-item-network"><a href="minerStatus.cgi">Miner Status</a></li>
