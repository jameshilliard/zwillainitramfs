...
<title>Upgrade new Zwilla Mod Firmware</title>
</head>
EOH
...
if [ "${ant_result}" == "" ]; then
	...
	echo "<span id=\"cbi-apply-cgminer-status\">Rebooting System ...wow! All works fine if you see this line, now waiting for rebooting the system<br>&nbsp;<br>(please wait for 60 seconds or check within the next 60 seconds)</span>"
	echo "</fieldset>"
else
	echo "<h2><a id=\"content\" name=\"content\">System Upgrade Zwilla Mod Failed</a></h2>"
