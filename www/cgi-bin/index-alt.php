...
define( 'EDD_SAMPLE_STORE_URL', 'https://www.zwilla.de' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file

// the name of your product. This should match the download name in EDD exactly
define( 'EDD_SAMPLE_ITEM_NAME', 'Custom Firmware Antminer S7 Zwilla Mod with cgminer 4.9.2 and crypto glance' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						...
						<td>
							<input id="edd_sample_license_key" name="edd_sample_license_key" type="text" class="regular-text" value="<?phpesc_attr_e( $license ); ?>" />
						...
						<tr valign="top">
							...
							<td>
								<?php if( $status !== false && $status == 'valid' ) { ?>
									...
									<?phpwp_nonce_field( 'edd_sample_nonce', 'edd_sample_nonce' ); ?>
