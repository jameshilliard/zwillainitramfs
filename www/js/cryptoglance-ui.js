...
function showToastUpdate(currentVersion, newestVersion) {
  ...
  $.cookie('zwillamod_version', newestVersion, { expires: 1 });
}
...
function showToastWriteError() {
  $().toastmessage('showToast', {
    sticky  : false,
    text    : '<b>Take care!</b><br>Warning! <em>Warning!</em> Warning!.',
    type    : 'error'
  });
}
...
function showToastNoHTACCESS() {
  $().toastmessage('showToast', {
    sticky  : true,
    text    : '<b>No .htaccess in !</b><br>Using this file to block access to your user data directory is a good idea. It\'s included in the source, but for some reason it does not exist in your installation. Ensure it contains the <a href="https://raw.githubusercontent.com/cryptoGlance/cryptoGlance-web-app/master/user_data/.htaccess" rel="external">contents of the source file</a>.',
    type    : 'warning'
  });
}
