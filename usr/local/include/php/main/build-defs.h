...
#define CONFIGURE_COMMAND " './configure'  '--enable-mbstring' '--enable-wddx' '--enable-fpm' '--with-gettext=/usr/lib/gettext' '--with-libxml-dir=/usr/include/libxml2/libxml' '--disable-embedded-mysqli' '--enable-sockets' '--enable-pcntl' '--enable-shared' '--with-curl=/usr/include'"
